...
const sharedActorRoutes = await Promise.all(['app/api/server-actions/route.ts','app/api/security/route.ts','app/api/panel-settings/route.ts','app/api/worlds/route.ts','app/api/server-content/route.ts','app/api/files/route.ts','app/api/backups/route.ts'].map(read))
