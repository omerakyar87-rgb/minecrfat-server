...
export function MinecraftServerHeroCard({ serverTitle = 'Create SMP', mediaUrl = '', mediaType = 'image', subtitles = defaultSubtitles, ipAddress = 'play.createsmp.com', playersOnline = 142, playersMax = 250, ping = 24, onSave }: MinecraftServerHeroCardProps) {
  ...
  return <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_400px]">
    <section className="min-w-0">
      <div className="mb-3 flex items-center justify-between px-1 text-xs font-medium uppercase tracking-[0.18em] text-cyan-300/80"><span className="flex items-center gap-2"><span className="size-1.5 rounded-full bg-cyan-300 shadow-[0_0_10px_#22d3ee]"/>Canlı görünüm</span><span className="text-slate-500">Ortalama sunucu vitrini</span></div>
